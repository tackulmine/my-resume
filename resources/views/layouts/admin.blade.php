                    ...
                    <div class="col-md-3">
                        <div class="card mb-4">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="/admin/home">Dashboard</a></li>
                                ...
                                <li class="list-group-item"><a href="{!! route('admin.interest.index') !!}">Interests</a></li>
                                <li class="list-group-item"><a href="{!! route('admin.social-media.index') !!}">Social Medias</a></li>
