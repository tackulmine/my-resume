    ...
    <div class="resume-section-content">
        ...
        <div class="resume-skill-item">
            ...
            <ul class="list-inline">
                <li class="list-inline-item"><span class="badge bg-primary">DevOps</span></li>
                <li class="list-inline-item"><span class="badge bg-primary">Code Review</span></li>
                <li class="list-inline-item"><span class="badge bg-primary">Git</span></li>
                <li class="list-inline-item"><span class="badge bg-primary">Unit Testing</span></li>
                <li class="list-inline-item"><span class="badge bg-primary">Wireframing</span></li>
                <li class="list-inline-item"><span class="badge bg-primary">Sketch</span></li>
                <li class="list-inline-item"><span class="badge bg-primary">Balsamiq</span></li>
